var input = `una bokpr ftz ryw nau yknf fguaczl anu
...
var arrayOfRows = input.split("\n");
var arrayOfArrays = [];
var validCounter = 0;

for (var i = 0; i < arrayOfRows.length; i++) {
    arrayOfArrays.push(arrayOfRows[i].split(" "));
}

for (var i = 0; i < arrayOfArrays.length; i++) {
    if ((new Set(arrayOfArrays[i])).size === arrayOfArrays[i].length) {
        validCounter++
    }
}

console.log("Day 4: " + validCounter);
